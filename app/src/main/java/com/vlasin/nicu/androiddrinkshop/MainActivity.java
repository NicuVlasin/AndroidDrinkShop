package com.vlasin.nicu.androiddrinkshop;
...
public class MainActivity extends AppCompatActivity {
        ...
        if (requestCode == REQUEST_CODE)
        {
            ...
            else
            {
                if (result.getAccessToken() != null)
                {
                    ...
                    //Get User phone and check if exists on server
                            ...
                            mService.checkUserExists(account.getPhoneNumber().toString())
                                    .enqueue(new Callback<CheckUserResponse>() {
                                        ...
                                        public void onResponse(Call<CheckUserResponse> call, Response<CheckUserResponse> response) {
                                            ...
                                            {
                                                //If User dose not exist then it needs to register
                                                alertDialog.dismiss();
    ...
    private void showRegisterDialog(final String phone) {
        /*
            I will create a new layout for custom dialog (register dialog)
         */
    ...
    /*
    Method to get the HASH Key from Facebook Developers
     */
    private void printKeyHash() {
        try{
            PackageInfo info = getPackageManager().getPackageInfo("com.vlasin.nicu.androiddrinkshop",
